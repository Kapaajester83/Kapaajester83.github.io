...
kalijester68@htb[/htb]$ ### Syntax: host [IP]
kalijester68@htb[/htb]$ sudo tcpdump -i eth0 host 172.16.146.2
...
kalijester68@htb[/htb]$ ### Syntax: src/dst [host|net|port] [IP|Network Range|Port]
kalijester68@htb[/htb]$ sudo tcpdump -i eth0 src host 172.16.146.2
...
kalijester68@htb[/htb]$ sudo tcpdump -i eth0 tcp src port 80
...
kalijester68@htb[/htb]$ sudo tcpdump -i eth0 dest net 172.16.146.0/24
...
kalijester68@htb[/htb]$ ### Syntax: [tcp/udp/icmp]
kalijester68@htb[/htb]$ sudo tcpdump -i eth0 udp
...
kalijester68@htb[/htb]$ ### Syntax: proto [protocol number]
kalijester68@htb[/htb]$ sudo tcpdump -i eth0 proto 17
...
kalijester68@htb[/htb]$ ### Syntax: port [port number]
kalijester68@htb[/htb]$ sudo tcpdump -i eth0 tcp port 443
...
kalijester68@htb[/htb]$ ### Syntax: portrange [portrange 0-65535]
kalijester68@htb[/htb]$ sudo tcpdump -i eth0 portrange 0-1024
...
kalijester68@htb[/htb]$ ### Syntax: less/greater [size in bytes]
kalijester68@htb[/htb]$ sudo tcpdump -i eth0 less 64
...
kalijester68@htb[/htb]$ sudo tcpdump -i eth0 greater 500
...
kalijester68@htb[/htb]$ ### Syntax: and [requirement]
kalijester68@htb[/htb]$ sudo tcpdump -i eth0 host 192.168.0.1 and port 23
...
kalijester68@htb[/htb]$ ### Syntax: or/|| [requirement]
kalijester68@htb[/htb]$ sudo tcpdump -r sus.pcap icmp or host 172.16.146.1
...
kalijester68@htb[/htb]$ ### Syntax: not/! [requirement]
kalijester68@htb[/htb]$ sudo tcpdump -r sus.pcap not icmp
...
kalijester68@htb[/htb]$sudo tcpdump -Ar telnet.pcap
...
kalijester68@htb[/htb]$ sudo tcpdump -Ar http.cap -l | grep 'mailto:*'
...
kalijester68@htb[/htb]$ tcpdump -i eth0 'tcp[13] &2 != 0'
...
kalijester68@htb[/htb]$ sudo tcpdump -i eth0 'tcp[13] &2 != 0'
...
RFC Quick Links 	This Wikipedia article contains a large list of protocols
 tied to the RFC that explains their implementation.
